...
def test_latitude_and_longitude_to_coordinates_corner1():
    height_map = HeightMap(raster=b'', base_coordinates=RasterBaseCoordinates.from_hgt_name("N40W008"))
    # x,y = 1, 1
...
def test_latitude_and_longitude_to_coordinates_ne():
    height_map = HeightMap(raster=b'', base_coordinates=RasterBaseCoordinates.from_hgt_name("N40E015"))
...
def test_latitude_and_longitude_to_coordinates_se():
    height_map = HeightMap(raster=b'', base_coordinates=RasterBaseCoordinates.from_hgt_name("S34E018"))
...
def test_latitude_and_longitude_to_coordinates_sw():
    height_map = HeightMap(raster=b'', base_coordinates=RasterBaseCoordinates.from_hgt_name("S08W015"))
